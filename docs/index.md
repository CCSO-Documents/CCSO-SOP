...
When practical, the police unit should be positioned at an angle behind the stopped vehicle. This positioning creates a safer working area for the deputy, improves visibility, and allows the patrol unit to provide a protective barrier if the suspect becomes hostile or begins firing.

### Positioning Expectations

Deputies should:

- Angle the patrol unit behind the stopped vehicle when roadway conditions allow.
- Keep enough room to safely exit the patrol unit.
- Use the patrol unit as available cover if a threat develops.
